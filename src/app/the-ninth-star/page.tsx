...
export const metadata: Metadata = {
  title: "Twinkle Live 〜 The ninth star 〜",
  openGraph: {
    title: "Twinkle Live 〜 The ninth star 〜",
    siteName: "Twinkle Live 〜 The ninth star 〜",
    type: "website",
    description: "ライブチケットのお申し込みはこちらから",
    url: "https://twinkle-live.info/the-ninth-star",
...
function Home() {
  ...
  return (
    <>
      {/* <Header /> */}
      <Jumbotron title="Twinkle Live" subtitle="~ The ninth star ~" />
